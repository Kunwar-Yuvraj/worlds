...
export async function POST(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    await appendStoryEvent(id, { type: 'narration', content: resolution.narration, scope: 'private', actorId: uid, audienceIds: [uid], payload: { cliffhanger: resolution.playerState.cliffhanger, options: resolution.options } });
