...
export type StoryEventInput = { type: 'action' | 'narration' | 'scene' | 'world' | 'system'; content: string; scope: 'private' | 'scene' | 'world'; actorId?: string | null; audienceIds?: string[]; sceneId?: string | null; payload?: Record<string, unknown> };
